...
function writeCSV!(arr_res::Vector{T},ginv_res::Union{GinvResultADMM, GinvResultSolver},ginv_code::Symbol,expn::String) where {T}
    # folder_1 = "..//ResultsCSV";
    folder_1 = "..//ResultsCSV//Experiment_" * expn
    # mkdir_ginv(folder_1)
    isdir(folder_1) || mkdir(folder_1)
    # File name
